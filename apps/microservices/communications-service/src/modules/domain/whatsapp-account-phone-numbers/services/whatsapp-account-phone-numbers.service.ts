...
export class WhatsappAccountPhoneNumbersDomainService {
  ...
  async create(
    ...
    this.logger.log(`Added phone number ${created.id} to WABA ${wabaId} (account ${accountId})`);
  ...
  async updateProfilePicture(
    ...
    this.logger.log(`Updated profile picture for phone number ${phoneNumberId} (account ${accountId})`);
  ...
  async requestNameChange(
    ...
    this.logger.log(`Requested display name change for phone number ${phoneNumberId} (account ${accountId})`);
  ...
  async register(accountId: string, phoneNumberId: string, pin: string): Promise<SuccessResponseDto> {
    ...
    this.logger.log(`Registered phone number ${phoneNumberId} for Cloud API (account ${accountId})`);
