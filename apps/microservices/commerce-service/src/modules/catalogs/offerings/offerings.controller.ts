...
export class OfferingsController {
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.table' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.create' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.findById' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.update' })
  ...
  // Deletes an offering
  @MessagePattern({ cmd: 'catalogs.offerings.delete' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.variants.create' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.variants.list' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.variants.update' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.variants.delete' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.modifiers.list' })
  ...
  @MessagePattern({ cmd: 'catalogs.offerings.modifiers.save' })
