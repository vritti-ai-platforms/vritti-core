...
@Controller()
export class OrgOfferingDimensionsController {
  private readonly logger = new Logger(OrgOfferingDimensionsController.name);
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.list' })
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.create' })
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.createFromTemplate' })
  createFromTemplate(
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.values.upsert' })
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.reorder' })
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.update' })
  ...
  @MessagePattern({ cmd: 'org.offerings.dimensions.delete' })
