...
@Controller()
export class OrgDimensionTemplateValuesController {
  private readonly logger = new Logger(OrgDimensionTemplateValuesController.name);
  ...
  @MessagePattern({ cmd: 'org.dimensionTemplates.values.upsert' })
