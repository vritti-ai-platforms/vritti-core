...
@Controller()
export class OrgOfferingDimensionTemplatesController {
  private readonly logger = new Logger(OrgOfferingDimensionTemplatesController.name);
  ...
  @MessagePattern({ cmd: 'org.offeringDimensionTemplates.list' })
  ...
  @MessagePattern({ cmd: 'org.offeringDimensionTemplates.get' })
  ...
  @MessagePattern({ cmd: 'org.offeringDimensionTemplates.create' })
  ...
  @MessagePattern({ cmd: 'org.offeringDimensionTemplates.update' })
  ...
  @MessagePattern({ cmd: 'org.offeringDimensionTemplates.setActive' })
  ...
  @MessagePattern({ cmd: 'org.offeringDimensionTemplates.delete' })
