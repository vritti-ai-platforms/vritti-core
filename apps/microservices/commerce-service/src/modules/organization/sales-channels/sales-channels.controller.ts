...
import { CreateSalesChannelDto } from '@domain/sales-channels/dto/request/create-sales-channel.dto';
import { UpdateSalesChannelDto } from '@domain/sales-channels/dto/request/update-sales-channel.dto';
...
export class SalesChannelsController {
  ...
  constructor(private readonly service: SalesChannelsDomainService) {}
