...
@Controller()
export class SiteDimensionTemplateValuesController {
  private readonly logger = new Logger(SiteDimensionTemplateValuesController.name);
  ...
  @MessagePattern({ cmd: 'site.dimensionTemplates.values.upsert' })
