...
export class InventoryItemsUomConversionsController {
  ...
  @MessagePattern({ cmd: 'site.inventoryItems.uomConversionsTable' })
  async table(
  ...
  @MessagePattern({ cmd: 'site.inventoryItems.addUomConversion' })
  async create(
  ...
  @MessagePattern({ cmd: 'site.inventoryItems.updateUomConversion' })
  async update(
  ...
  @MessagePattern({ cmd: 'site.inventoryItems.removeUomConversion' })
