...
export class SiteAppCatalogChannelController {
  ...
  @MessagePattern({ cmd: 'site.appCatalogChannels.table' })
  ...
  @MessagePattern({ cmd: 'site.appCatalogChannels.update' })
  ...
  @MessagePattern({ cmd: 'site.appCatalogChannels.delete' })
  ...
  @MessagePattern({ cmd: 'site.appCatalogChannels.items' })
  findItemsForTable(
  ...
  @MessagePattern({ cmd: 'site.appCatalogChannels.setItemVisibility' })
  setItemVisibility(
