...
export class SuppliersContactsController {
  ...
  @MessagePattern({ cmd: 'site.suppliers.contacts' })
  ...
  @MessagePattern({ cmd: 'site.suppliers.addContact' })
  addContact(
  ...
  @MessagePattern({ cmd: 'site.suppliers.updateContact' })
  updateContact(
  ...
  @MessagePattern({ cmd: 'site.suppliers.deleteContact' })
  ...
  @MessagePattern({ cmd: 'site.suppliers.markPrimaryContact' })
