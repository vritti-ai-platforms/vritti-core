...
export class SiteOfferingVariantsController {
  ...
  @MessagePattern({ cmd: 'site.offerings.variants.bom.lines.add' })
  ...
  @MessagePattern({ cmd: 'site.offerings.variants.bom.lines.update' })
  ...
  @MessagePattern({ cmd: 'site.offerings.variants.bom.lines.delete' })
  ...
  @MessagePattern({ cmd: 'site.offerings.variants.bom.addSuggested' })
