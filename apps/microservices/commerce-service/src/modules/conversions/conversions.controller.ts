...
export class ConversionsController {
  ...
  async table(@Payload() state: TableViewState): Promise<{ result: ConversionDto[]; count: number }> {
  ...
  async complete(
    @Payload() data: { id: string; locationId: string; inputBatchIds?: Record<string, string> },
