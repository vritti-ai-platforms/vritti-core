...
export class LeAppCatalogChannelController {
  ...
  @MessagePattern({ cmd: 'le.appCatalogChannels.table' })
  ...
  @MessagePattern({ cmd: 'le.appCatalogChannels.create' })
  ...
  @MessagePattern({ cmd: 'le.appCatalogChannels.update' })
  ...
  @MessagePattern({ cmd: 'le.appCatalogChannels.delete' })
  ...
  @MessagePattern({ cmd: 'le.appCatalogChannels.items' })
  findItemsForTable(
  ...
  @MessagePattern({ cmd: 'le.appCatalogChannels.setItemVisibility' })
  setItemVisibility(
