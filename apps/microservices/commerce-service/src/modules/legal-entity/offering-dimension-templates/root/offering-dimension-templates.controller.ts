...
@Controller()
export class LeOfferingDimensionTemplatesController {
  private readonly logger = new Logger(LeOfferingDimensionTemplatesController.name);
  ...
  @MessagePattern({ cmd: 'le.offeringDimensionTemplates.list' })
  ...
  @MessagePattern({ cmd: 'le.offeringDimensionTemplates.get' })
  ...
  // Creates a legal-entity-owned dimension template; values are added through their own endpoint
  @MessagePattern({ cmd: 'le.offeringDimensionTemplates.create' })
  ...
  // Updates a dimension template this legal-entity owns
  @MessagePattern({ cmd: 'le.offeringDimensionTemplates.update' })
  ...
  @MessagePattern({ cmd: 'le.offeringDimensionTemplates.setActive' })
  ...
  // Deletes a dimension template this legal-entity owns
  @MessagePattern({ cmd: 'le.offeringDimensionTemplates.delete' })
