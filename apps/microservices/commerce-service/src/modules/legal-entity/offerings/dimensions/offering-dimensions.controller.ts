...
@Controller()
export class LeOfferingDimensionsController {
  private readonly logger = new Logger(LeOfferingDimensionsController.name);
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.list' })
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.create' })
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.createFromTemplate' })
  createFromTemplate(
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.values.upsert' })
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.reorder' })
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.update' })
  ...
  @MessagePattern({ cmd: 'le.offerings.dimensions.delete' })
