...
@Controller()
export class LeOfferingsController {
  private readonly logger = new Logger(LeOfferingsController.name);
  ...
  // Creates a legal entity-owned offering; dimensions and variants follow
  @MessagePattern({ cmd: 'le.offerings.create' })
  ...
  // Updates an offering this legal entity owns
  @MessagePattern({ cmd: 'le.offerings.update' })
  ...
  @MessagePattern({ cmd: 'le.offerings.setFulfilment' })
  ...
  @MessagePattern({ cmd: 'le.offerings.setTaxClass' })
  ...
  @MessagePattern({ cmd: 'le.offerings.setStatus' })
  ...
  @MessagePattern({ cmd: 'le.offerings.bulkSetStatus' })
  ...
  // Deletes an offering this legal entity owns; refused while it has variants
  @MessagePattern({ cmd: 'le.offerings.delete' })
