...
export class SuppliersContactsController {
  ...
  @MessagePattern({ cmd: 'le.suppliers.contacts' })
  ...
  @MessagePattern({ cmd: 'le.suppliers.addContact' })
  addContact(
  ...
  @MessagePattern({ cmd: 'le.suppliers.updateContact' })
  updateContact(
  ...
  @MessagePattern({ cmd: 'le.suppliers.deleteContact' })
  ...
  @MessagePattern({ cmd: 'le.suppliers.markPrimaryContact' })
