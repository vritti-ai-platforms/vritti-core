...
export class LeDimensionTemplatesController {
  private readonly logger = new Logger(LeDimensionTemplatesController.name);
  ...
  @MessagePattern({ cmd: 'le.dimensionTemplates.list' })
  ...
  @MessagePattern({ cmd: 'le.dimensionTemplates.create' })
  ...
  @MessagePattern({ cmd: 'le.dimensionTemplates.update' })
  ...
  @MessagePattern({ cmd: 'le.dimensionTemplates.setActive' })
  ...
  @MessagePattern({ cmd: 'le.dimensionTemplates.delete' })
