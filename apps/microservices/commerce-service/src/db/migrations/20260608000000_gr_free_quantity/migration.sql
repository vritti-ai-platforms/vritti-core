...
CREATE TYPE "vritti_core"."free_scheme_mode" AS ENUM ('slab', 'pro_rata');--> statement-breakpoint

ALTER TABLE "vritti_core"."supplier_items"
  ADD COLUMN "scheme_buy_qty" numeric(12, 3),
  ADD COLUMN "scheme_free_qty" numeric(12, 3),
  ADD COLUMN "scheme_mode" "vritti_core"."free_scheme_mode";--> statement-breakpoint

ALTER TABLE "vritti_core"."purchase_order_items"
  ADD COLUMN "scheme_buy_qty" numeric(12, 3),
  ADD COLUMN "scheme_free_qty" numeric(12, 3),
  ADD COLUMN "scheme_mode" "vritti_core"."free_scheme_mode",
