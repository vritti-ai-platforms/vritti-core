...
import { boolean, index, pgPolicy, timestamp, uuid, varchar } from '@vritti/api-sdk/drizzle-pg-core';
...
export const catalogs = coreSchema.table(
  ...
  (table) => [
    index('idx_catalogs_bu').on(table.organizationId, table.businessUnitId),
