...
import { QuickCreateCustomerModal } from '@/site/features/customers/forms/QuickCreateCustomerModal';
import { useCreateOrder } from '@/site/hooks/orders';
import { usePosTerminal } from '@/site/hooks/pos-terminals/usePosTerminal';
