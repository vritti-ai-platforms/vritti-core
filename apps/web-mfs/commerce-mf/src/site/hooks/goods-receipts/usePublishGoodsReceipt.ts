...
import { publishGoodsReceipt } from '@/site/services/goods-receipts.service';
import { GOODS_RECEIPT_KEY, GOODS_RECEIPT_TREE_KEY, GOODS_RECEIPTS_TABLE_KEY } from './keys';
