...
import { UOM_TABLE_KEY, useDeleteUom, useUomTable } from '@/org/hooks/uom';
    ...
    <>
      <DataTable
        ...
        emptyStateConfig={{
          ...
          action: (
            <Button onClick={addDialog.open} startAdornment={<Plus className="size-4" />} permission={ORG_UOM.add}>
              Add UOM
            </Button>
          ),
        }}
