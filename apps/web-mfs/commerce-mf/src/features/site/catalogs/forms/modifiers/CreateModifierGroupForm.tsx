...
import { useCreateModifierGroup } from '@/hooks/site/modifiers';
...
export const CreateModifierGroupForm: React.FC<CreateModifierGroupFormProps> = ({ catalogId, onSuccess, onCancel }) => {
