import { SITE_OFFERING_DIMENSION_TEMPLATES as PERMISSIONS } from '@vritti/commerce-permissions/offering-dimension-templates';
...
import { useDeleteDimensionTemplate, useSetDimensionTemplateActive } from '@/hooks/site/dimension-templates';
