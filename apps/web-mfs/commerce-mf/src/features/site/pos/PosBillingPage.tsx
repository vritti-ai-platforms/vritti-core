...
import { QuickCreateCustomerModal } from '@/features/site/customers/forms/QuickCreateCustomerModal';
import { useCreateOrder } from '@/hooks/site/orders';
import { usePosTerminal } from '@/hooks/site/pos-terminals/usePosTerminal';
