...
import { useCreateCompanyRegistration } from '@/hooks/organization/companies';
import {
...
export const AddRegistrationDialog: React.FC<AddRegistrationDialogProps> = ({ companyId, onSuccess, onCancel }) => {
  ...
  const createMutation = useCreateCompanyRegistration(companyId, { onSuccess });
