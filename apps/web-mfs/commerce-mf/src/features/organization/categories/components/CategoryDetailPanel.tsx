...
const CategoryDetailContent: React.FC<CategoryDetailContentProps> = ({ category, onSelectCategory }) => {
  ...
  const columns = useMemo<ColumnDef<CategoryData>[]>(
    () => [
      ...
      {
        accessorKey: 'defaultTaxClassName',
        header: 'Tax Class',
        cell: ({ row }) =>
          row.original.defaultTaxClassName ? (
            <Badge variant="outline">{row.original.defaultTaxClassName}</Badge>
          ) : (
        ...
        actions={
          <>
            <Button
              ...
              permission={ORG_CATEGORIES.edit}
            >
              Edit
            </Button>
            <Button
              ...
              permission={ORG_CATEGORIES.delete}
            >
              Delete
            </Button>
          </>
      ...
      {isGroup ? (
        <div>
          ...
          <DataTable
            ...
            permission={ORG_CATEGORIES.view}
            toolbarActions={{
              actions: (
                <Button
                  size="sm"
