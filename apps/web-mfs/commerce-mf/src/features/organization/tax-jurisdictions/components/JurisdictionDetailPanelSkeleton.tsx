...
// Loading content for the jurisdiction detail panel: title + actions, the detail fields, and the children table.
export function JurisdictionDetailPanelSkeleton() {
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-nowrap items-start gap-2 overflow-x-auto">
        <DetailSectionSkeleton count={4} wrap />
      </div>
