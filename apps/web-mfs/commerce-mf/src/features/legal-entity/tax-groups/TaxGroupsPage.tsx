...
import { TAX_GROUPS_TABLE_KEY, useDeleteTaxGroup, useTaxGroupsTable } from '@/hooks/legal-entity/tax-groups';
          ...
          <RowActions
            actions={[
              ...
              },
              {
                ...
                icon: Trash2,
                label: 'Delete',
                permission: LE_TAX_GROUPS.delete,
                variant: 'destructive',
