import { LE_OFFERING_DIMENSION_TEMPLATES as PERMISSIONS } from '@vritti/commerce-permissions/offering-dimension-templates';
...
import { useDeleteDimensionTemplate, useSetDimensionTemplateActive } from '@/hooks/legal-entity/dimension-templates';
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col gap-6">
      <PageHeader
        ...
        actions={
          <Button onClick={addDialog.open} startAdornment={<Plus className="size-4" />} permission={PERMISSIONS.add}>
            Add Template
          </Button>
        }
      />
