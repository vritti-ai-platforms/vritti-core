...
import { DimensionTemplateGridSkeleton } from './DimensionTemplateGridSkeleton';
import { DimensionTemplatesGrid } from './DimensionTemplatesGrid';
import { AddDimensionTemplateDialog } from './forms/AddDimensionTemplateDialog';
import type { DimensionTemplatesBinding } from './types';

interface DimensionTemplatesPageProps {
  binding: DimensionTemplatesBinding;
}

export const DimensionTemplatesPage: React.FC<DimensionTemplatesPageProps> = ({ binding }) => {
  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col gap-6">
      ...
      <Dialog
        ...
        content={(close) => (
          <AddDimensionTemplateDialog
            useCreateDimensionTemplate={binding.useCreate}
            onSuccess={close}
            onCancel={close}
          />
        )}
