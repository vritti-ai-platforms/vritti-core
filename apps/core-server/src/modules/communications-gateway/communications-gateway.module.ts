...
import { SmsProviderTemplatesGatewayController } from './org-api/sms-providers/templates/sms-provider-templates-gateway.controller';
...
@Module({
  ...
  controllers: [
    ...
    SmsProviderTemplatesGatewayController,
