...
export class SiteSupplierItemResponseDto {
  ...
  @ApiPropertyOptional({ type: CurrencyAmountDto, description: 'Current resolved unit price', nullable: true })
  ...
  @ApiPropertyOptional({ description: 'Effective minimum order quantity', nullable: true })
  minOrderQuantity: number | null;

  @ApiPropertyOptional({ description: 'Effective lead time in days', nullable: true })
