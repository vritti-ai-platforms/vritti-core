...
@ApiTags('Commerce - Offerings (Org)')
@ApiBearerAuth()
@Require(AuthType.Session, SessionTypeValues.WEB)
@RequireFeature(ORG_OFFERINGS.featureCode)
@Controller('org/offerings')
export class OrgOfferingsGatewayController {
  private readonly logger = new Logger(OrgOfferingsGatewayController.name);

  constructor(private readonly service: OrgOfferingsGatewayService) {}
  ...
  @Post(':id/dimensions')
  @HttpCode(HttpStatus.CREATED)
  @RequirePermission(ORG_OFFERINGS.dimensions.add)
  @ApiCreateOfferingDimension()
  createDimension(
    @Param('id') id: string,
    @Body() dto: CreateOfferingDimensionDto,
  ): Promise<CreateResponseDto<OfferingDimensionResponseDto>> {
    this.logger.log(`POST /commerce-api/org/offerings/${id}/dimensions`);
  ...
  @RequirePermission(ORG_OFFERINGS.dimensions.edit)
  @ApiUpsertOfferingDimensionValues()
  upsertDimensionValues(
    @Param('dimensionId') dimensionId: string,
    @Body() dto: UpsertOfferingDimensionValuesDto,
  ): Promise<SuccessResponseDto> {
    this.logger.log(`PUT /commerce-api/org/offerings/dimensions/${dimensionId}/values`);
  ...
  reorderDimensions(@Param('id') id: string, @Body() dto: ReorderOfferingDimensionsDto): Promise<SuccessResponseDto> {
    this.logger.log(`PUT /commerce-api/org/offerings/${id}/dimensions/order`);
  ...
  updateDimension(
    ...
    this.logger.log(`PATCH /commerce-api/org/offerings/dimensions/${dimensionId}`);
    return this.service.updateDimension(dimensionId, dto);
  }

  @Delete('dimensions/:dimensionId')
  @RequirePermission(ORG_OFFERINGS.dimensions.delete)
  @ApiDeleteOfferingDimension()
  deleteDimension(@Param('dimensionId') dimensionId: string): Promise<SuccessResponseDto> {
    this.logger.log(`DELETE /commerce-api/org/offerings/dimensions/${dimensionId}`);
  ...
  @RequirePermission(ORG_OFFERINGS.variants.view)
  @ApiOfferingVariantsTable()
  getVariantsTable(@Param('id') id: string, @UserId() userId: string): Promise<OfferingVariantTableResponseDto> {
    this.logger.log(`GET /commerce-api/org/offerings/${id}/variants/table`);
  ...
  @RequirePermission(ORG_OFFERINGS.variants.add)
  @ApiPreviewOfferingVariantCombinations()
  previewVariantCombinations(
    @Param('id') id: string,
    @Body() dto: PreviewCombinationsDto,
  ): Promise<VariantCombinationsResponseDto> {
    this.logger.log(`POST /commerce-api/org/offerings/${id}/variants/combinations`);
  ...
  generateVariants(@Param('id') id: string, @Body() dto: GenerateVariantsDto): Promise<SuccessResponseDto> {
    this.logger.log(`POST /commerce-api/org/offerings/${id}/variants/generate`);
  ...
  createVariant(
    ...
    this.logger.log(`POST /commerce-api/org/offerings/${id}/variants`);
  ...
  getVariant(@Param('variantId') variantId: string): Promise<OfferingVariantResponseDto> {
    this.logger.log(`GET /commerce-api/org/offerings/variants/${variantId}`);
    return this.service.findVariantById(variantId);
  }

  // Reaches into inventory items, so it carries its own grant rather than riding on variants.edit
  @Post('variants/:variantId/bom/inventory-item')
  @HttpCode(HttpStatus.CREATED)
  @RequirePermission(ORG_OFFERINGS.variants.bom.createInventoryItem)
  @ApiCreateVariantInventoryItem()
  createInventoryItem(
    @Param('variantId') variantId: string,
    @Body() dto: CreateVariantInventoryItemDto,
  ): Promise<CreateResponseDto<OfferingVariantResponseDto>> {
    this.logger.log(`POST /commerce-api/org/offerings/variants/${variantId}/bom/inventory-item`);
    return this.service.createInventoryItem(variantId, dto);
  }
  ...
  updateVariant(@Param('variantId') variantId: string, @Body() dto: UpdateVariantDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/variants/${variantId}`);
  ...
  @Patch(':id/fulfilment')
  @RequirePermission(ORG_OFFERINGS.edit)
  @ApiSetOfferingFulfilment()
  setFulfilment(@Param('id') id: string, @Body() dto: SetFulfilmentDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/${id}/fulfilment`);
  ...
  setVariantFulfilment(
    ...
    this.logger.log(`PATCH /commerce-api/org/offerings/variants/${variantId}/fulfilment`);
  ...
  clearVariantFulfilment(@Param('variantId') variantId: string): Promise<SuccessResponseDto> {
    this.logger.log(`DELETE /commerce-api/org/offerings/variants/${variantId}/fulfilment`);
  ...
  setTaxClass(@Param('id') id: string, @Body() dto: SetTaxClassDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/${id}/tax-class`);
  ...
  setVariantTaxClass(@Param('variantId') variantId: string, @Body() dto: SetTaxClassDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/variants/${variantId}/tax-class`);
  ...
  @RequirePermission(ORG_OFFERINGS.variants.bom.addFromSuggestion)
  @ApiAddSuggestedComponent()
  addSuggestedComponent(@Param('variantId') variantId: string): Promise<SuccessResponseDto> {
    this.logger.log(`POST /commerce-api/org/offerings/variants/${variantId}/bom/suggested`);
    return this.service.addSuggestedComponent(variantId);
  }

  // Deletes a variant
  @Delete('variants/:variantId')
  @RequirePermission(ORG_OFFERINGS.variants.delete)
  @ApiDeleteOfferingVariant()
  deleteVariant(@Param('variantId') variantId: string): Promise<SuccessResponseDto> {
    this.logger.log(`DELETE /commerce-api/org/offerings/variants/${variantId}`);
  ...
  @Patch('status')
  @RequirePermission(ORG_OFFERINGS.toggle)
  @ApiBulkSetOfferingStatus()
  bulkSetStatus(@Body() dto: BulkSetOfferingStatusDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/status — ${dto.ids.length} selected`);
  ...
  bulkSetVariantsStatus(@Param('id') id: string, @Body() dto: BulkSetVariantsStatusDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/${id}/variants/status — ${dto.ids.length} selected`);
  ...
  update(@Param('id') id: string, @Body() dto: UpdateOfferingDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/${id}`);
  ...
  setStatus(@Param('id') id: string, @Body() dto: SetOfferingStatusDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/offerings/${id}/status`);
    return this.service.setStatus(id, dto.isActive);
  }

  // Deletes an offering; refused while it has variants
  @Delete(':id')
  @RequirePermission(ORG_OFFERINGS.delete)
  @ApiDeleteOffering()
