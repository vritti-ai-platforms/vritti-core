...
export class OrgOfferingsGatewayService {
  ...
  async findVariantById(variantId: string): Promise<OfferingVariantResponseDto> {
    this.logger.log(`org.offerings.variants.get — id: ${variantId}`);
    return this.nats.send('commerce', 'org.offerings.variants.get', { id: variantId });
  }
  ...
  async findById(id: string): Promise<OfferingResponseDto> {
    ...
    return this.nats.send('commerce', 'org.offerings.get', { id });
  }
