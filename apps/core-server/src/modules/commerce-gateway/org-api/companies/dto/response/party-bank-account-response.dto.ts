...
export class PartyBankAccountResponseDto {
  ...
  @ApiProperty({ description: 'The company (party) ID' })
  partyId: string;

  @ApiProperty({ description: 'Account holder name', example: 'Acme Foods Pvt Ltd' })
  accountName: string;
  ...
  @ApiPropertyOptional({ description: 'UPI ID', example: 'acme@hdfcbank', nullable: true })
  upiId: string | null;
