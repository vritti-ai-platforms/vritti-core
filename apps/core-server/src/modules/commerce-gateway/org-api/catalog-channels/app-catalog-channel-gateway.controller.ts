...
export class AppCatalogChannelGatewayController {
  ...
  findForTable(@UserId() userId: string, @OrgId() orgId: string): Promise<CatalogChannelTableResponseDto> {
    this.logger.log('GET /commerce-api/org/catalog-channels/app/table');
  ...
  update(@Param('channelId') channelId: string, @Body() dto: UpdateAppChannelDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/org/catalog-channels/app/${channelId}`);
  ...
  remove(@Param('channelId') channelId: string): Promise<SuccessResponseDto> {
    this.logger.log(`DELETE /commerce-api/org/catalog-channels/app/${channelId}`);
  ...
  findItemsForTable(
    ...
    this.logger.log(`GET /commerce-api/org/catalog-channels/app/${channelId}/items/table`);
  ...
  setItemVisibility(
    ...
    this.logger.log(`PATCH /commerce-api/org/catalog-channels/app/${channelId}/items/${listingId}`);
