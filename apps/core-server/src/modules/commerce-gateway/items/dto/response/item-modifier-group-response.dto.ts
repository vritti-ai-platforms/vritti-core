...
export class ItemModifierOptionResponseDto {
...
export class ItemModifierGroupResponseDto {
  ...
  @ApiProperty({ description: 'Modifier options', type: [ItemModifierOptionResponseDto] })
  options: ItemModifierOptionResponseDto[];
}
