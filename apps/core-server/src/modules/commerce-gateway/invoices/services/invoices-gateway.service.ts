...
export class InvoicesGatewayService {
  ...
  async create(dto: CreateInvoiceDto): Promise<InvoiceResponseDto> {
    ...
    return this.nats.send('commerce', 'invoices.create', dto);
  }
