...
export class InventoryItemsGatewayController {
  ...
  @ApiQuery({
    ...
    type: String,
    description:
      "Exclude items that have all UOMs already linked to this supplier",
  })
  @RequireSession(SessionTypeValues.NEXUS, SessionTypeValues.MOBILE)
  select(
    @Query() query: InventoryItemsSelectQueryDto,
  ...
  ): Promise<CreateResponseDto<InventoryItemResponseDto>> {
  ...
  ): Promise<InventoryItemLedgerTableResponseDto> {
  ...
  getQuantsTable(
    @Param("id") id: string,
    @UserId() userId: string,
  ): Promise<InventoryItemQuantTableResponseDto> {
  ...
  getLotsTable(
    @Param("id") id: string,
    @UserId() userId: string,
  ): Promise<InventoryItemLotTableResponseDto> {
  ...
  async createLocation(
    @Param("id") id: string,
    @Body() dto: CreateInventoryItemLocationDto,
  ) {
  ...
  updateLocation(
    ...
    this.logger.log(
      `PATCH /commerce-api/inventory-items/${id}/locations/${locationConfigId}`,
    );
  ...
  deleteLocation(
    ...
    this.logger.log(
      `DELETE /commerce-api/inventory-items/${id}/locations/${locationConfigId}`,
    );
  ...
  getUomConversionsTable(@Param("id") id: string, @UserId() userId: string) {
    this.logger.log(
      `GET /commerce-api/inventory-items/${id}/uom-conversions/table`,
    );
  ...
  updateUomConversion(
    ...
    this.logger.log(
      `PATCH /commerce-api/inventory-items/${id}/uom-conversions/${conversionId}`,
    );
  ...
  deleteUomConversion(
    ...
    this.logger.log(
      `DELETE /commerce-api/inventory-items/${id}/uom-conversions/${conversionId}`,
    );
