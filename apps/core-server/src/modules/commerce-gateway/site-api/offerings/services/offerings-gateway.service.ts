...
@Injectable()
export class SiteOfferingsGatewayService {
  private readonly logger = new Logger(SiteOfferingsGatewayService.name);
  ...
  async findForTable(orgId: string, userId: string): Promise<OfferingTableResponseDto> {
    this.logger.log('site.offerings.table');
  ...
  async findVariantById(variantId: string): Promise<OfferingVariantResponseDto> {
    this.logger.log(`site.offerings.variants.findById — id: ${variantId}`);
    return this.nats.send('commerce', 'site.offerings.variants.findById', { id: variantId });
  }

  async findVariantsForTable(userId: string, offeringId: string): Promise<OfferingVariantTableResponseDto> {
    this.logger.log(`site.offerings.variants.table — offeringId: ${offeringId}`);
    const { state, activeViewId } = await this.dataTableStateService.getCurrentState(
      userId,
      `commerce-site-offering-${offeringId}-variants`,
    );

    const { result, count } = await this.nats.send<{ result: OfferingVariantResponseDto[]; count: number }>(
      'commerce',
      'site.offerings.variants.table',
      { offeringId, ...state },
    );
  ...
  async findById(orgId: string, id: string): Promise<OfferingResponseDto> {
    this.logger.log(`site.offerings.findById — id: ${id}`);
    const offering = await this.nats.send<OfferingResponseDto>('commerce', 'site.offerings.findById', { id });
  ...
  async create(dto: CreateOfferingDto): Promise<CreateResponseDto<OfferingResponseDto>> {
    ...
    return this.nats.send('commerce', 'site.offerings.create', dto);
  }

  async update(id: string, dto: UpdateOfferingDto): Promise<SuccessResponseDto> {
    this.logger.log(`offerings.update — id: ${id}`);
    return this.nats.send('commerce', 'site.offerings.update', { id, ...dto });
  }
  ...
  async setStatus(id: string, isActive: boolean): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.setStatus', { id, isActive });
  }
  ...
  async bulkSetStatus(dto: BulkSetOfferingStatusDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.bulkSetStatus', dto);
  }
  ...
  async bulkSetVariantsStatus(offeringId: string, dto: BulkSetVariantsStatusDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.bulkSetStatus', { offeringId, ...dto });
  }

  async delete(id: string): Promise<SuccessResponseDto> {
    this.logger.log(`offerings.delete — id: ${id}`);
    return this.nats.send('commerce', 'site.offerings.delete', { id });
  }
  ...
  async listDimensions(offeringId: string): Promise<OfferingDimensionResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.offerings.dimensions.list', { offeringId });
  }
  ...
  async createDimension(
    ...
    return this.nats.send('commerce', 'site.offerings.dimensions.create', { offeringId, ...dto });
  }
  ...
  async createDimensionFromTemplate(
    ...
    this.logger.log(`site.offerings.dimensions.createFromTemplate — templateId: ${dto.templateId}`);
    return this.nats.send('commerce', 'site.offerings.dimensions.createFromTemplate', { offeringId, ...dto });
  }

  async reorderDimensions(offeringId: string, dimensionIds: string[]): Promise<SuccessResponseDto> {
    this.logger.log(`site.offerings.dimensions.reorder — offeringId: ${offeringId}`);
    return this.nats.send('commerce', 'site.offerings.dimensions.reorder', { offeringId, dimensionIds });
  }

  async upsertDimensionValues(dimensionId: string, dto: UpsertOfferingDimensionValuesDto): Promise<SuccessResponseDto> {
    this.logger.log(`site.offerings.dimensions.values.upsert — dimensionId: ${dimensionId}`);
    return this.nats.send('commerce', 'site.offerings.dimensions.values.upsert', { dimensionId, ...dto });
  }
  ...
  async updateDimension(dimensionId: string, dto: UpdateOfferingDimensionDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.dimensions.update', { id: dimensionId, ...dto });
  }
  ...
  async deleteDimension(dimensionId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.dimensions.delete', { id: dimensionId });
  }
  ...
  async previewVariantCombinations(
    ...
    return this.nats.send('commerce', 'site.offerings.variants.combinations', { offeringId, ...dto });
  }
  ...
  async generateVariants(offeringId: string, dto: GenerateVariantsDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.generate', { offeringId, ...dto });
  }
  ...
  async createVariant(
    ...
    return this.nats.send('commerce', 'site.offerings.variants.create', { offeringId, ...dto });
  }
  ...
  async updateVariant(variantId: string, dto: UpdateVariantDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.update', { id: variantId, ...dto });
  }
  ...
  async setFulfilment(id: string, dto: SetFulfilmentDto): Promise<SuccessResponseDto> {
    this.logger.log(`site.offerings.setFulfilment — id: ${id}, type: ${dto.fulfilmentType}`);
    return this.nats.send('commerce', 'site.offerings.setFulfilment', { id, ...dto });
  }
  ...
  async setVariantFulfilment(variantId: string, dto: SetFulfilmentDto): Promise<SuccessResponseDto> {
    this.logger.log(`site.offerings.variants.setFulfilment — id: ${variantId}, type: ${dto.fulfilmentType}`);
    return this.nats.send('commerce', 'site.offerings.variants.setFulfilment', { id: variantId, ...dto });
  }
  ...
  async clearVariantFulfilment(variantId: string): Promise<SuccessResponseDto> {
    this.logger.log(`site.offerings.variants.clearFulfilment — id: ${variantId}`);
    return this.nats.send('commerce', 'site.offerings.variants.clearFulfilment', { id: variantId });
  }

  async setTaxClass(id: string, dto: SetTaxClassDto): Promise<SuccessResponseDto> {
    this.logger.log(`offerings.setTaxClass — id: ${id}`);
    return this.nats.send('commerce', 'site.offerings.setTaxClass', { id, ...dto });
  }
  ...
  async setVariantTaxClass(variantId: string, dto: SetTaxClassDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.setTaxClass', { id: variantId, ...dto });
  }
  ...
  async clearVariantTaxClass(variantId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.clearTaxClass', { id: variantId });
  }
  ...
  async addBomLine(variantId: string, dto: AddBomLineDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.bom.lines.add', { variantId, ...dto });
  }
  ...
  async updateBomLine(lineId: string, dto: UpdateBomLineDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.bom.lines.update', { id: lineId, ...dto });
  }
  ...
  async deleteBomLine(lineId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.bom.lines.delete', { id: lineId });
  }
  ...
  async addSuggestedComponent(variantId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.variants.bom.addSuggested', { variantId });
  }

  async deleteVariant(variantId: string): Promise<SuccessResponseDto> {
    this.logger.log(`offerings.variants.delete — id: ${variantId}`);
    return this.nats.send('commerce', 'site.offerings.variants.delete', { id: variantId });
  }
}
