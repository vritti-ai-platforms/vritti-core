...
export class SiteOfferingsGatewayService {
  ...
  async findVariantById(variantId: string): Promise<OfferingVariantResponseDto> {
    this.logger.log(`site.offerings.variants.get — id: ${variantId}`);
    return this.nats.send('commerce', 'site.offerings.variants.get', { id: variantId });
  }
  ...
  async findById(id: string): Promise<OfferingResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offerings.get', { id });
  }
