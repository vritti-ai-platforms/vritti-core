...
@Injectable()
export class SiteOfferingDimensionTemplatesGatewayService {
  private readonly logger = new Logger(SiteOfferingDimensionTemplatesGatewayService.name);
  ...
  async list(search?: string): Promise<OfferingDimensionTemplateResponseDto[]> {
    this.logger.log('site.offeringDimensionTemplates.list');
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.list', { search });
  }
  ...
  async create(
    ...
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.create', dto);
  }
  ...
  async findById(id: string): Promise<OfferingDimensionTemplateResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.get', { id });
  }
  ...
  async update(id: string, dto: UpdateOfferingDimensionTemplateDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.update', { id, ...dto });
  }
  ...
  async setActive(id: string, isActive: boolean): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.setActive', { id, isActive });
  }

  // Deletes a template the workspace owns
  async delete(id: string): Promise<SuccessResponseDto> {
    this.logger.log(`offeringDimensionTemplates.delete — id: ${id}`);
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.delete', { id });
  }
  ...
  async upsertValues(templateId: string, values: TemplateValueInputDto[]): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.offeringDimensionTemplates.values.upsert', { templateId, values });
  }
}
