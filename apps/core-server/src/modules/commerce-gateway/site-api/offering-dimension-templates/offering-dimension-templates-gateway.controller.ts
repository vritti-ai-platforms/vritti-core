...
import { SiteOfferingDimensionTemplatesGatewayService } from './services/offering-dimension-templates-gateway.service';

@ApiTags('Commerce - Dimension Templates (Site)')
@ApiBearerAuth()
@Require(AuthType.Session, SessionTypeValues.WEB)
@RequireFeature(SITE_OFFERING_DIMENSION_TEMPLATES.featureCode)
@Controller('site/dimension-templates')
export class SiteOfferingDimensionTemplatesGatewayController {
  private readonly logger = new Logger(SiteOfferingDimensionTemplatesGatewayController.name);

  constructor(private readonly service: SiteOfferingDimensionTemplatesGatewayService) {}

  // Returns every dimension template this workspace can reach
  @Get()
  @RequirePermission(SITE_OFFERING_DIMENSION_TEMPLATES.view)
  @ApiListOfferingDimensionTemplates()
  ...
  @RequirePermission(SITE_OFFERING_DIMENSION_TEMPLATES.add)
  @ApiCreateOfferingDimensionTemplate()
  create(
  ...
  findById(@Param('id') id: string): Promise<OfferingDimensionTemplateResponseDto> {
    this.logger.log(`GET /commerce-api/site/dimension-templates/${id}`);
    return this.service.findById(id);
  }

  // Updates a dimension template by ID
  @Patch(':id')
  @RequirePermission(SITE_OFFERING_DIMENSION_TEMPLATES.edit)
  @ApiUpdateOfferingDimensionTemplate()
  ...
  @Patch(':id/active')
  @RequirePermission(SITE_OFFERING_DIMENSION_TEMPLATES.toggle)
  @ApiSetOfferingDimensionTemplateActive()
  ...
  @Delete(':id')
  @RequirePermission(SITE_OFFERING_DIMENSION_TEMPLATES.delete)
  @ApiDeleteOfferingDimensionTemplate()
  ...
  @Put(':id/values')
  @RequirePermission(SITE_OFFERING_DIMENSION_TEMPLATES.values.upsert)
  @ApiUpsertOfferingDimensionTemplateValues()
  upsertValues(
    @Param('id') id: string,
