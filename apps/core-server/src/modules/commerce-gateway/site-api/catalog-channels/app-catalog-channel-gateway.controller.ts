...
export class SiteAppCatalogChannelGatewayController {
  ...
  findForTable(@UserId() userId: string, @OrgId() orgId: string): Promise<CatalogChannelTableResponseDto> {
    this.logger.log('GET /commerce-api/site/catalog-channels/app/table');
  ...
  update(@Param('channelId') channelId: string, @Body() dto: UpdateAppChannelDto): Promise<SuccessResponseDto> {
    this.logger.log(`PATCH /commerce-api/site/catalog-channels/app/${channelId}`);
  ...
  remove(@Param('channelId') channelId: string): Promise<SuccessResponseDto> {
    this.logger.log(`DELETE /commerce-api/site/catalog-channels/app/${channelId}`);
  ...
  findItemsForTable(
    ...
    this.logger.log(`GET /commerce-api/site/catalog-channels/app/${channelId}/items/table`);
  ...
  setItemVisibility(
    ...
    this.logger.log(`PATCH /commerce-api/site/catalog-channels/app/${channelId}/items/${listingId}`);
