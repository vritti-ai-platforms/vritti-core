...
import type { AddStockAdjustmentLotDto } from '@commerce/stock-adjustments/dto/request/add-stock-adjustment-lot.dto';
import type { CreateStockAdjustmentDto } from '@commerce/stock-adjustments/dto/request/create-stock-adjustment.dto';
import type { UpdateChangeStockAdjustmentLineDto } from '@commerce/stock-adjustments/dto/request/update-change-stock-adjustment-line.dto';
import type { UpdateOpeningStockAdjustmentLineDto } from '@commerce/stock-adjustments/dto/request/update-opening-stock-adjustment-line.dto';
import type { UpdateStockAdjustmentDto } from '@commerce/stock-adjustments/dto/request/update-stock-adjustment.dto';
import type { UpdateStockAdjustmentLineItemDto } from '@commerce/stock-adjustments/dto/request/update-stock-adjustment-line-item.dto';
import type { UpdateStockAdjustmentLotDto } from '@commerce/stock-adjustments/dto/request/update-stock-adjustment-lot.dto';
import type { StockAdjustmentLineItemResponseDto } from '@commerce/stock-adjustments/dto/response/stock-adjustment-line-item-response.dto';
import type { StockAdjustmentLineItemTableResponseDto } from '@commerce/stock-adjustments/dto/response/stock-adjustment-line-item-table-response.dto';
import type { StockAdjustmentLineResponseDto } from '@commerce/stock-adjustments/dto/response/stock-adjustment-line-response.dto';
import type { StockAdjustmentLineTableResponseDto } from '@commerce/stock-adjustments/dto/response/stock-adjustment-line-table-response.dto';
import type { StockAdjustmentLotDetailResponseDto } from '@commerce/stock-adjustments/dto/response/stock-adjustment-lot-detail-response.dto';
import type { StockAdjustmentLotResponseDto } from '@commerce/stock-adjustments/dto/response/stock-adjustment-lot-response.dto';
