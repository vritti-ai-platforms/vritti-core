...
export class SuppliersGatewayService {
  ...
  async create(dto: CreateSupplierDto): Promise<CreateResponseDto<SupplierResponseDto>> {
    ...
    return this.nats.send('commerce', 'site.suppliers.create', dto);
  }

  // Finds a supplier by ID
  async findById(id: string): Promise<SupplierResponseDto> {
    this.logger.log('suppliers.findById');
    return this.nats.send('commerce', 'site.suppliers.findById', { id });
  }
  ...
  async findItemIds(supplierId: string): Promise<string[]> {
    ...
    return this.nats.send('commerce', 'site.suppliers.itemIds', { supplierId });
  }
  ...
  async findContacts(supplierId: string): Promise<SupplierContactResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.suppliers.contacts', { supplierId });
  }
  ...
  async update(id: string, dto: UpdateSupplierDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.update', { id, ...dto });
  }

  // Deletes a supplier by ID
  async delete(id: string): Promise<SuccessResponseDto> {
    this.logger.log('suppliers.delete');
    return this.nats.send('commerce', 'site.suppliers.delete', { id });
  }
  ...
  async changeCurrency(id: string, dto: ChangeSupplierCurrencyDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.changeCurrency', { id, ...dto });
  }
  ...
  async addItem(supplierId: string, dto: AddSupplierItemDto): Promise<CreateResponseDto<SupplierItemResponseDto>> {
    ...
    return this.nats.send('commerce', 'site.suppliers.addItem', { supplierId, ...dto });
  }
  ...
  async updateItem(
    ...
    return this.nats.send('commerce', 'site.suppliers.updateItem', { supplierId, supplierItemId, ...dto });
  }
  ...
  async unlinkItem(supplierId: string, supplierItemId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.unlinkItem', { supplierId, supplierItemId });
  }
  ...
  async bulkUnlinkItems(supplierId: string, dto: BulkUnlinkSupplierItemsDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.bulkUnlinkItems', {
      supplierId,
  ...
  async bulkSetItemScheme(supplierId: string, dto: BulkSetSupplierItemSchemeDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.bulkSetItemScheme', {
      supplierId,
      supplierItemIds: dto.supplierItemIds,
  ...
  async bulkSetItemPreferred(supplierId: string, dto: BulkSetSupplierItemPreferredDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.bulkSetItemPreferred', {
      supplierId,
      supplierItemIds: dto.supplierItemIds,
  ...
  async addContact(
    ...
    return this.nats.send('commerce', 'site.suppliers.addContact', { supplierId, ...dto });
  }
  ...
  async updateContact(
    ...
    return this.nats.send('commerce', 'site.suppliers.updateContact', { supplierId, contactId, ...dto });
  }
  ...
  async deleteContact(supplierId: string, contactId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.deleteContact', { supplierId, contactId });
  }
  ...
  async markPrimaryContact(supplierId: string, contactId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.suppliers.markPrimaryContact', { supplierId, contactId });
  }
  ...
  async findItemPrice(supplierId: string, inventoryItemId: string): Promise<{ unitPrice: CurrencyAmountDto | null }> {
    ...
    return this.nats.send('commerce', 'site.suppliers.findItemPrice', { supplierId, inventoryItemId });
  }
}
