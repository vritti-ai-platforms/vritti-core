...
import type { CreateModifierOptionDto } from '@commerce/catalogs/dto/request/create-modifier-option.dto';
import type { CreateOfferingDto } from '@commerce/catalogs/dto/request/create-offering.dto';
import type { CreateVariantDto } from '@commerce/catalogs/dto/request/create-variant.dto';
import type { CreateVariantOptionDto } from '@commerce/catalogs/dto/request/create-variant-option.dto';
import type { SaveOfferingModifiersDto } from '@commerce/catalogs/dto/request/save-offering-modifiers.dto';
import type { UpdateCatalogDto } from '@commerce/catalogs/dto/request/update-catalog.dto';
import type { UpdateModifierGroupDto } from '@commerce/catalogs/dto/request/update-modifier-group.dto';
import type { UpdateModifierOptionDto } from '@commerce/catalogs/dto/request/update-modifier-option.dto';
import type { UpdateOfferingDto } from '@commerce/catalogs/dto/request/update-offering.dto';
import type { UpdateVariantDto } from '@commerce/catalogs/dto/request/update-variant.dto';
import type { UpdateVariantOptionDto } from '@commerce/catalogs/dto/request/update-variant-option.dto';
...
export class CatalogsGatewayService {
  ...
  async findForTable(userId: string): Promise<CatalogTableResponseDto> {
    ...
    const { state, activeViewId } = await this.dataTableStateService.getCurrentState(userId, 'commerce-site-catalogs');
  ...
  findById(id: string): Promise<CatalogResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.findById', { id });
  }
  ...
  clone(sourceCatalogId: string): Promise<CreateResponseDto<CatalogResponseDto>> {
    ...
    return this.nats.send('commerce', 'site.catalogs.clone', { sourceCatalogId });
  }
  ...
  listChannels(catalogId: string): Promise<CatalogChannelResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.catalogs.channels.list', { catalogId });
  }
  ...
  assignChannel(catalogId: string, dto: AssignCatalogChannelDto): Promise<CatalogChannelResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.channels.assign', { catalogId, ...dto });
  }
  ...
  unassignChannel(assignmentId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.channels.unassign', { id: assignmentId });
  }
  ...
  async findOfferingsForTable(catalogId: string, userId: string): Promise<OfferingsTableResponseDto> {
    ...
    const { state, activeViewId } = await this.dataTableStateService.getCurrentState(userId, 'commerce-site-offerings');
  ...
  createOffering(catalogId: string, dto: CreateOfferingDto): Promise<CreateResponseDto<OfferingResponseDto>> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.create', { ...dto, catalogId });
  }
  ...
  findOfferingById(offeringId: string): Promise<OfferingDetailResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.findById', { offeringId });
  }
  ...
  updateOffering(offeringId: string, dto: UpdateOfferingDto): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.update', { offeringId, ...dto });
  }
  ...
  deleteOffering(offeringId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.delete', { offeringId });
  }
  ...
  createOfferingVariant(offeringId: string, dto: CreateVariantDto): Promise<OfferingVariantResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.variants.create', { offeringId, ...dto });
  }
  ...
  listOfferingVariants(offeringId: string): Promise<OfferingVariantResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.variants.list', { offeringId });
  }
  ...
  updateOfferingVariant(variantId: string, dto: UpdateVariantDto): Promise<OfferingVariantResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.variants.update', { variantId, ...dto });
  }
  ...
  deleteOfferingVariant(variantId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.variants.delete', { variantId });
  }
  ...
  listOfferingModifiers(offeringId: string): Promise<OfferingModifierGroupResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.modifiers.list', { offeringId });
  }
  ...
  saveOfferingModifiers(
    ...
    return this.nats.send('commerce', 'site.catalogs.offerings.modifiers.save', {
      itemId: offeringId,
  ...
  listVariantOptions(catalogId: string): Promise<VariantOptionResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.catalogs.variant-options.list', { catalogId });
  }
  ...
  selectVariantOptions(catalogId: string, query: SelectOptionsQueryDto): Promise<SelectQueryResult> {
    ...
    return this.nats.send('commerce', 'site.catalogs.variant-options.select', { catalogId, ...query });
  }
  ...
  createVariantOption(catalogId: string, dto: CreateVariantOptionDto): Promise<VariantOptionResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.variant-options.create', { catalogId, ...dto });
  }
  ...
  updateVariantOption(optionId: string, dto: UpdateVariantOptionDto): Promise<VariantOptionResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.variant-options.update', { optionId, ...dto });
  }
  ...
  deleteVariantOption(optionId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.variant-options.delete', { optionId });
  }
  ...
  listModifierGroups(catalogId: string): Promise<ModifierGroupResponseDto[]> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.list', { catalogId });
  }
  ...
  selectModifierGroups(catalogId: string, query: SelectOptionsQueryDto): Promise<SelectQueryResult> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.select', { catalogId, ...query });
  }
  ...
  getModifierGroup(groupId: string): Promise<ModifierGroupResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.get', { groupId });
  }
  ...
  createModifierGroup(catalogId: string, dto: CreateModifierGroupDto): Promise<ModifierGroupResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.create', { ...dto, catalogId });
  }
  ...
  updateModifierGroup(groupId: string, dto: UpdateModifierGroupDto): Promise<ModifierGroupResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.update', { groupId, ...dto });
  }
  ...
  deleteModifierGroup(groupId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.delete', { groupId });
  }
  ...
  createModifierOption(groupId: string, dto: CreateModifierOptionDto): Promise<ModifierOptionResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.options.create', { groupId, ...dto });
  }
  ...
  updateModifierOption(optionId: string, dto: UpdateModifierOptionDto): Promise<ModifierOptionResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.options.update', { optionId, ...dto });
  }
  ...
  deleteModifierOption(optionId: string): Promise<SuccessResponseDto> {
    ...
    return this.nats.send('commerce', 'site.catalogs.modifiers.options.delete', { optionId });
  }
}
