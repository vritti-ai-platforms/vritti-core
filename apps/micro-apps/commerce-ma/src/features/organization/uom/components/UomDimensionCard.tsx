...
export function UomDimensionCard({ dimension, onPress }: UomDimensionCardProps) {
  return (
    <CardPressable className="gap-2 p-4" onPress={() => onPress?.(dimension)}>
      <View className="flex-row items-center gap-2">
        ...
        <Badge variant="secondary">
          <Text className="text-[10px] font-semibold uppercase text-secondary-foreground">{dimension.code}</Text>
        </Badge>
      </View>
