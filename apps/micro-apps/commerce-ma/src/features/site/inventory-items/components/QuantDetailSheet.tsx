...
export const QuantDetailSheet = forwardRef<BottomSheetRef, QuantDetailSheetProps>(({ quant, uomSymbol }, ref) => {
      ...
      <View className="px-4 pb-4">
        {quant ? (
          <>
            ...
            <Row label="Manufacturing Date" value={fmt.date(quant.manufacturingDate).primary} />
