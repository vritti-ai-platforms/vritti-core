  ...
  return (
    <View className="flex-1">
      <FlashList
        ...
        emptyText={
          debounced ? "No dimensions match your search." : "No dimensions yet."
        }
        renderItem={({ item: dimension }) => (
          <UomDimensionCard
            dimension={dimension}
            onPress={(selected) =>
              navigation.navigate("UomDimensionDetail", { id: selected.id })
            }
          />
        )}
      />
